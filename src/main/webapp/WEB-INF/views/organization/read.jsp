                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
											...
											<input class="form-control" type="text" name="TELEPHONE" value="${paramMap.TELEPHONE}" >
                                        </div>
										<button type="submit" class="btn btn-default">Edit Button</button>
										<a href="<c:url value='/organization/delete?ORGANIZATION_SEQ=${paramMap.ORGANIZATION_SEQ}'/>"> <button type="button" class="btn btn-default">Delete Button</button></a>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<input class="form-control" type="text" name="PARENT_ORGANIZATION_SEQ" value="${paramMap.PARENT_ORGANIZATION_SEQ}" >
                                    </div>
                                    <div class="form-group">
										<label>ORDER_NUMBER Static Control</label>
										<input class="form-control" type="text" name="ORDER_NUMBER" value="${paramMap.ORDER_NUMBER}" >
                                    </div>
                                </div>
								</form>
                                <!-- /.col-lg-6 (nested) -->
