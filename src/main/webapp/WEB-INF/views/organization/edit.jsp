                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/organization/submit' />">
										<div class="form-group">
										    <label for="disabledSelect">ORGANIZATION_SEQ Disabled input </label>
										    <c:choose>
											    <c:when test="${resultMap.ORGANIZATION_SEQ != null}">
											    	<input class="form-control" type="text" name="ORGANIZATION_SEQ" value="${resultMap.ORGANIZATION_SEQ}">
											    </c:when>
											    <c:otherwise>
											    	<input class="form-control" type="text" name="ORGANIZATION_SEQ" value="${resultMap.commonutil}">
											    </c:otherwise>
										    </c:choose>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="TELEPHONE" value ="${resultMap.TELEPHONE}" placeholder="000) 00-0000-0000">
                                            <p class="help-block">Base form 000) 00-0000-0000</p>
                                        </div>
                                        <div class="form-group">
										    <label for="disabledSelect">ORDER_NUMBER Disabled input </label>
										    <input class="form-control" type="text" name="ORDER_NUMBER"  value ="${resultMap.ORDER_NUMBER}" >
