                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
								<form role="form" method="POST" action="<c:url value='/member?action=edit' />">
                                <div class="col-lg-6">
	                                    <div class="form-group">
											<label>MEMBER_ID Static Control</label><input class="form-control" type="text" name="MEMBER_ID" value="${resultMap.MEMBER_ID}" >
	                                    </div>
	                                    <div class="form-group">
											<label>PASSWORD Static Control</label><input class="form-control" type="text" name="PASSWORD" value="${resultMap.PASSWORD}" >
	                                    </div>
	                                    <div class="form-group">
											<label>NAME Static Control</label><input class="form-control" type="text" name="NAME" value="${resultMap.NAME}" >
	                                    </div>
	                                    <div class="form-group">
	                                    ...
	                                    <div class="form-group">
											...
											<input class="form-control" type="text" name="CELLPHONE" value="${resultMap.CELLPHONE}" >
	                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
										...
										<input class="form-control" type="text" name="MEMBER_SEQ" value="${resultMap.MEMBER_SEQ}" >
                                    </div>
                                </div>
								</form>
                                <!-- /.col-lg-6 (nested) -->
