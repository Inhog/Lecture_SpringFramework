                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/member?action=submit' />">
										<div class="form-group">
										    <label for="disabledSelect">MEMBER_SEQ Disabled input </label>
										    <c:choose>
											    <c:when test="${paramMap.MEMBER_SEQ != null}">
											    	<input class="form-control" type="text" name="MEMBER_SEQ" value="${paramMap.MEMBER_SEQ}">
											    </c:when>
											    <c:otherwise>
											    	<input class="form-control" type="text" name="MEMBER_SEQ" value="${paramMap.commonutil}">
											    </c:otherwise>
										    </c:choose>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="MEMBER_ID" value="${paramMap.MEMBER_ID}">
                                        </div>
                                        <div class="form-group">
                                            <label>Member PASSWORD Text Input </label>
                                            <input class="form-control" type="password" name="PASSWORD"  value="${paramMap.PASSWORD}">
                                        </div>
                                        <div class="form-group">
                                            <label>Member Name Text Input </label>
                                            <input class="form-control" type="text" name="NAME"  value="${paramMap.NAME}">
                                        </div>
                                        <div class="form-group">
                                            <label>EMAIL Text Input with Placeholder </label>
                                            <input class="form-control" type="text" name="EMAIL"  value="${paramMap.EMAIL}" placeholder="incubator@clustringincubation.com">
                                            <p class="help-block">Base form incubator@clustringincubation.com</p>
                                        </div>
                                        <div class="form-group">
                                            <label>CELLPHONE Text Input with Placeholder </label>
                                            <input class="form-control" type="text" name="CELLPHONE"  value="${paramMap.CELLPHONE}" placeholder="000-0000-0000">
                                            <p class="help-block">Base form 000-0000-0000</p>
                                        </div>
                                        <button type="submit" class="btn btn-default">Submit Button</button>
                                        <button type="reset" class="btn btn-default">Reset Button</button>
                                        <a href="<c:url value='/' />"><button type="button" class="btn btn-default">Go to Home</button></a>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
